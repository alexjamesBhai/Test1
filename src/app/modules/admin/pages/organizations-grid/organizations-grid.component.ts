      ...
      >
        <div
          *ngFor="let org of organizations"
          class="bg-white rounded-lg shadow hover:shadow-lg transition p-6 border border-slate-200"
        >
          ...
          <div class="space-y-2 text-sm mb-4">
            ...
            <p class="text-slate-600">
              <strong>Created:</strong> {{ org.createdAt | date: "short" }}
            </p>
          </div>

          <div class="flex gap-2">
            <button
              class="flex-1 px-4 py-2 bg-blue-100 hover:bg-blue-200 text-blue-700 rounded-lg font-semibold transition"
            >
              👁️ View
            </button>
            <button
