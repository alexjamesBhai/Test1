...
export class ApiService {
  ...
  toggleOrganization(id: string, isActive: boolean): Observable<Organization> {
    return this.http.patch<Organization>(
      `${this.baseUrl}/organizations/${id}/toggle`,
      { isActive },
    );
  }
  ...
  updateUser(
    ...
    return this.http.put<User>(
      `${this.baseUrl}/organizations/${organizationId}/users/${userId}`,
      data,
    );
  }
  ...
  deactivateUser(organizationId: string, userId: string): Observable<User> {
    return this.http.patch<User>(
      `${this.baseUrl}/organizations/${organizationId}/users/${userId}/deactivate`,
      {},
    );
  }
  ...
  resetUserPassword(
    ...
    return this.http.post<{ success: boolean }>(
      `${this.baseUrl}/organizations/${organizationId}/users/${userId}/reset-password`,
      { newPassword },
    );
  }
  ...
  getProducts(
    ...
    return this.http.get<Product[]>(
      `${this.baseUrl}/organizations/${organizationId}/products`,
      { params },
    );
  }
  ...
  searchProducts(organizationId: string, query: string): Observable<Product[]> {
    return this.http.get<Product[]>(
      `${this.baseUrl}/organizations/${organizationId}/products/search?q=${query}`,
    );
  }
  ...
  getProductByBarcode(
    ...
    return this.http.get<Product>(
      `${this.baseUrl}/organizations/${organizationId}/products/barcode/${barcode}`,
    );
  }
  ...
  updateProduct(
    ...
    return this.http.put<Product>(
      `${this.baseUrl}/organizations/${organizationId}/products/${productId}`,
      data,
    );
  }
  ...
  getCategories(organizationId: string): Observable<Category[]> {
    return this.http.get<Category[]>(
      `${this.baseUrl}/organizations/${organizationId}/categories`,
    );
  }
  ...
  updateCategory(
    ...
    return this.http.put<Category>(
      `${this.baseUrl}/organizations/${organizationId}/categories/${categoryId}`,
      data,
    );
  }
  ...
  getSales(organizationId: string): Observable<Sale[]> {
    return this.http.get<Sale[]>(
      `${this.baseUrl}/organizations/${organizationId}/sales`,
    );
  }
  ...
  getSaleReceipt(organizationId: string, saleId: string): Observable<Sale> {
    return this.http.get<Sale>(
      `${this.baseUrl}/organizations/${organizationId}/sales/${saleId}`,
    );
  }
}
